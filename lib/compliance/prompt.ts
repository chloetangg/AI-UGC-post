...
Exception: the pool hashtag #曼谷必吃 may appear in the hashtags array. COVER mainTitle MAY use 必吃 as one natural keyword from 曼谷 / centralwOrld / 泰餐 / 美食 / 必吃. Post titles and caption must still not hard-sell 必吃.
